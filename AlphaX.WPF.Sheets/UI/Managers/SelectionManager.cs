...
internal class SelectionManager(AlphaXSpread spread) : UIManager(spread), ISelectionManager
{
    ...
    public void SelectRange(CellRange range) => SelectRange(range.TopRow, range.LeftColumn, range.RowCount, range.ColumnCount);
