...
internal class ColumnHeadersInteractionLayer : InteractionLayer
{
    ...
    protected override void OnMouseMove(MouseEventArgs e)
    {
        ...
        Cursor = hitTest.Element == VisualElement.ColumnHeaderResizeBar && SheetView.Spread.AllowColumnResize
            ? SheetUtils.ColumnResizeCursor
            : SheetUtils.ColumnHeaderCursor;
