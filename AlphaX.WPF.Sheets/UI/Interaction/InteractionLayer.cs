...
using AlphaX.WPF.Sheets.Rendering.RenderRegions;
...
internal abstract class InteractionLayer : Canvas
{
    ...
    /// </summary>
    /// <returns></returns>
    protected SpreadHitTestResult HitTest() => HitTest(Mouse.GetPosition(SheetView.Spread));

    protected SpreadHitTestResult HitTest(Point point) => SheetView.Spread.HitTest(point);
