...
{
    public static void DrawText(this DrawingContext context, string text, Rect bounds, Style style, double pixelPerDip, bool characterEllipses = false) => context.DrawDrawing(new GlyphRunDrawing(style.Foreground, CreateGlyphRun(text, style, bounds, pixelPerDip, characterEllipses)));
