...
internal abstract class AlphaXSheetViewRegion : Canvas
{
    ...
    protected AlphaXSheetViewRegion() => SnapsToDevicePixels = true;

    public virtual void AttachSheet(AlphaXSheetView sheetView) => SheetView = sheetView;
    ...
    /// </summary>
    /// <returns></returns>
    public InteractionLayer GetInteractionLayer() => _interactionLayer;
    ...
    /// <returns></returns>
    public SpreadHitTestResult HitTest(Point point) => HitTestCore(SheetView, point);
