...
public class Style : NamedStyle
{
    ...
    public void SetBackground(AlphaX.Sheets.Drawing.Color color) => Background = new SolidColorBrush(Color.FromArgb(color.A, color.R, color.G, color.B));

    public void SetForeground(AlphaX.Sheets.Drawing.Color color) => Foreground = new SolidColorBrush(Color.FromArgb(color.A, color.R, color.G, color.B));
    ...
    public void SetPadding(AlphaX.Sheets.Drawing.Thickness thickness) => WpfPadding = new Thickness(thickness.Left, thickness.Top, thickness.Right, thickness.Bottom);
    ...
    public override IStyle Clone() => new Style()
    {
