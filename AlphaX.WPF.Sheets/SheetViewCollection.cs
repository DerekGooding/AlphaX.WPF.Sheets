...
public class SheetViewCollection : IEnumerable<IAlphaXSheetView>, INotifyCollectionChanged
{
    ...
    public IEnumerator<IAlphaXSheetView> GetEnumerator() => _sheetViewStore.Values.GetEnumerator();

    public IAlphaXSheetView GetSheetView(WorkSheet workSheet) => _sheetViewStore[workSheet];
